...
3. 针对异常的生化指标(如高血糖、高血压、高尿酸等)，必须给出针对性的饮食禁忌和运动建议。
4. 每条 text 控制在 45-100 字之间，明确频率、时长、控制方式或注意事项。
5. 若某项数据缺失，只能依据已有数据保守建议，不能编造检验结果。
6. dietTags 返回 3-6 个短标签，例如“控糖控油”“规律三餐”“优质蛋白”“低嘌呤”。
7. 严格返回合法 JSON，不要 markdown，不要解释文字。
